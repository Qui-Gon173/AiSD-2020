...
Сортировка данных, которые не помещаются в ОЗУ.
...
*Распределение* — это процесс разделения упорядоченных серий на 2 (и более) вспомогательных файла.  
*Слияние* — объединение 2 (и более) упорядоченных серий в одну последовательность.  
*Серия* — упорядоченный по ключу отрезок.  
*Фаза* — однократная обработке всей последовательности.  
*Виды слияния (двухпутевое и многопутевое)* — данные распределяются на 2 и 3 (и более) вспомогательных файла/ов соответственно.
